...
class Producer:
    ...
    async def _resp_task(self, message: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            request = {"message": message, "response_channel": response_channel_id}

            # put the request into the stream
            message_id: str = await self.client.redis.xadd(self.stream_name, request)
            ...
            try:
                ...
                response = {"error": "JSON Decoding Error"}
    ...
    def addUnconfirmedMessage(self, message: str) -> AnyFuture:
        """
    ...
    # pylint: disable=invalid-name
    def addConfirmedMessage(self, message: str) -> AnyFuture:
        """
        ...
        # create a task to add it to the stream
        future = self._resp_task(message)
